...
const HeroSection = () => {
  return (
    <section className="relative z-10 w-full min-h-[100svh] md:min-h-[85vh] flex flex-col md:flex-row border-b-4 border-divider overflow-visible">
      <ScatteredStars />
      {/* Left - Text */}
      <div className="flex-1 px-5 pt-2 pb-6 md:p-12 flex flex-col justify-center items-start border-b-4 md:border-b-0 md:border-r-4 border-divider relative" style={{ backgroundColor: '#D52B1E' }}>
        ...
        <h1
          className="w-full max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl mt-4 md:-mt-6 -mb-4 md:-mb-8 z-10 text-white text-[4.5rem] leading-[0.85] md:text-[7rem] lg:text-[9rem] xl:text-[11rem] font-['Bebas_Neue'] tracking-wide drop-shadow-[4px_4px_0_rgba(0,0,0,1)] text-left"
        ...
        <p className="text-[13px] md:text-2xl font-bold mb-6 md:mb-10 max-w-xl leading-relaxed z-10 text-white">
          ...
          Hockey jerseys, no last call,<br />
          Mad Monkey Canada Day — we do it all.
        </p>
        <a
          href="#selector"
      ...
      {/* Right - Image */}
      <div className="flex-1 relative flex items-center justify-center min-h-[300px] md:min-h-[400px]" style={{ backgroundColor: '#FFFFFF' }}>
        <div className="relative w-4/5 aspect-square md:aspect-auto md:h-4/5 flex items-center justify-center">
          <img
            src={heroImage}
            alt="Canada Day Party"
