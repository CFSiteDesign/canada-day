            ...
            filteredProperties.map((prop) => (
              ...
              >
                ...
                {prop.url ? (
                  ...
                  <span className="block w-full text-center bg-[#722F37] text-white font-black uppercase py-3 md:py-4 border-2 border-border text-sm md:text-base cursor-not-allowed">
                    COMING SOON
                  </span>
                )}
              </div>
